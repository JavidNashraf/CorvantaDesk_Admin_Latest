...
export function Modal({
  ...
  RemoveCreditText = "Remove Credit",
  submitText = "Add",
            ...
            {({ errors, touched, values }) => {
              ...
              return (
                <Form>
                                        ...
                                        return (
                                          <div className="w-full">
                                            <select
                                              ...
                                              className="form-select appearance-none block w-full px-[16px] h-[52px] text-base font-normal text-[#FFFFFF] bg-[#08090A] bg-clip-padding bg-no-repeat border-none rounded-[8px] transition ease-in-out m-0 focus:bg-[#08090A] focus:border-none focus:outline-none"
                                            >
                                                          ...
                                                          (result) => {
                                                            return (
                                                              <li
                                                                ...
                                                                key={result.id}
                                                                className="px-2 py-1.5 cursor-pointer capitalize border-t border-[#323248] hover:bg-[#323248] text-[#FFFFFF]"
                                                              >
                                                                {result.fullName}
                                                              </li>
                                                            );
                                        ...
                                        return (
                                          <div className="modal__form-el-password">
                                            <label
                                              ...
                                              key={name}
                                              htmlFor="typeFile"
                                              className="w-full px-[16px] h-[52px] text-[#FFFFFF] bg-[#171723] rounded-[8px] transition ease-in-out focus:bg-[#171723] focus:border-none focus:outline-none"
                                            >
                                              <div
                                                style={{
                                                  color: "#3699FF",
                                                    ...
                                                    user.fullName && (
                                                      ...
                                                      >
                                                        <div className="image_wr">
                                                          ...
                                                          <div className="lablwrap"> 
                                                            <a href={isClients ? `/admin/dashboard/billing/clients/list/details/${user.id}` : `/admin/dashboard/settings/users/list/admin-details/${user.id}`}>
                                                              {user.fullName}
                                                            </a>
                                                          </div>
                                                        </div>
                  ...
                  <div
                    className={`modal__buttons grid ${submitText ? "grid-cols-2" : "grid-cols-1"
                      }`}
                  >
                    <button
                    ...
                    {submitText && (
                      <Button
                        htmlType="submit"
                        loading={loading}
                        className={`modal__buttons-btn modal__buttons-btn${btnSuccess ? "-success" : btnDanger ? "-danger" : "-primary"}`}
