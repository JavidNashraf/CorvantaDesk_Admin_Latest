        ...
        {searchTerm.length > 1 && (
          <div className="relative w-full text-left">
            {searchResults?.length > 0 ? (
              ...
              <div className="overflow-hidden absolute top-0 right-0 left-0 m-0 border-1 border-[#323248] bg-[#171723] z-50 rounded-md pt-2 px-2.5 pb-3 shadow-md text-[#FFFFFF]">
                ...
                <div className="w-full lg:w-1/2" key={field?.name}>
                  <div className="flex items-center justify-between mr-3 py-1 border-b-[1px] border-b-[#323248] border-dashed">
                    ...
                    <select
                      ...
                      placeholder="Any"
                      name={field?.name}
                      className="form-select appearance-none text-[14px] block w-full p-2 text-base font-normal text-[#FFFFFF] bg-[#171723] bg-clip-padding bg-no-repeat border-none rounded-[8px] transition ease-in-out m-0 focus:bg-[#171723] focus:border-none focus:outline-none"
                    >
                ...
                <div className="w-full lg:w-1/2" key={field?.name}>
                  <div className="flex items-center justify-between mr-3 py-1 border-b-[1px] border-b-[#323248] border-dashed">
                    ...
                    <$DatePicker.RangePicker
                      ...
                      format="MM/DD/YYYY"
                      separator={<></>}
                      className="custom-date-picker w-full h-[41px] bg-[#171723] rounded-[8px] text-[#92928F] flex items-center justify-between px-[16px]"
                    />
                  </div>
                </div>
              );
