...
export function RefundCaptureSuccess({
  show,
  setShow,
  handleCancel
}) {
  ...
  return (
    <SimpleModal
      ...
      setShow={setShow}
      onHide={handleClose}
      heading="Refund Captured Successfully"
    ...
    >
      <div className="text-center flex flex-col gap-[20px] mb-[8px]">
        ...
        <p className="text-[#474761]">
          Congratulations! Your refund has been successfully processed. You may go back and continue.
        </p>
      </div>
    </SimpleModal>
  );
