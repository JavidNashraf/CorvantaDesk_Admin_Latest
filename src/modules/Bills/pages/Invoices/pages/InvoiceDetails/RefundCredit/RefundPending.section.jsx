...
export function RefundCapturePending({
  show,
  setShow,
}) {
  const handleClose = () => {
  ...
  return (
    <SimpleModal
      ...
      setShow={setShow}
      onHide={handleClose}
      heading="Refund Capture Pending"
    ...
    >
      <div className="text-center flex flex-col gap-[20px] mb-[8px]">
        ...
        <p className="text-[#474761]">
          It looks like we're still processing your refund. Please check back in a while for an update.
        </p>
      </div>
    </SimpleModal>
  );
